...
<body class="bg" style="background-image: url('bgdark.jpg');">
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-5">
            <h2 class="text-center text-dark mb-0 mt-5">LAPORIN</h2>
            <P class="text-center text-dark mb-5">Laporan Indonesia</P>
            <div class="card mt-5">
                <div class="card-body">
