...
<div class="container">
            ...
            <div class="content content-bottom shadow">
                <div>
                    ...
                    <div class="row text-center">
                        <div class="col">
                            <p class="italic mt-2">Terverifikasi</p>
                            <div class="text-center">
                                {{ $hitung[0] }}
                            </div>
                        </div>
                        <div class="col">
                            <p class="italic mt-2">Proses</p>
                            <div class="text-center">
                                {{ $hitung[1] }}
                            </div>
                        </div>
                        <div class="col">
                            <p class="italic mt-2">Selesai</p>
                            <div class="text-center">
                                {{ $hitung[2] }}
                            </div>
                        </div>
    ...
    <div class="row mt-5">
        <div class="col-lg-8">
            ...
            <a class="d-inline tab text-dark {{ $siapa == 'me' ? 'tab-active' : ''}}" href="{{ route('pekat.laporan', 'me') }}">
                Laporan Saya
            </a>
        ...
        <div class="col-lg-8">
            ...
            <div class="laporan-bottom">
                ...
                @endif
                @if ($v->tanggapan != null)
                <p class="mt-3 mb-1">{{ 'Tanggapan Dari Petugas'}}</p>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">@ Alfan Hafiidh Nugraha 2022</p>
    </div>
</div>
@endsection
